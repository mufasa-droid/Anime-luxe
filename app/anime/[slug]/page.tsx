...
export default async function AnimeSeriesPage({
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 pb-20 pt-20 sm:pt-28 md:pt-32">
      ...
      {/* Series Hero Banner */}
      <div className="glass-strong relative mb-8 sm:mb-12 overflow-hidden rounded-2xl sm:rounded-3xl p-5 sm:p-12 border border-neutral-200 dark:border-white/10 shadow-xl">
        <div
        ...
        <div className="relative z-10 max-w-2xl">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-neutral-300 dark:border-white/15 bg-neutral-200/60 dark:bg-white/5 px-3 py-0.5 sm:px-3 sm:py-1 text-[11px] sm:text-xs font-semibold tracking-widest text-neutral-800 dark:text-white">
            <Sparkles size={11} className="text-accent-pink" />
            OFFICIAL COLLECTION
          </span>
          ...
          <p className="mt-1.5 text-xs sm:text-sm text-neutral-600 dark:text-white/60">
      ...
      {/* Products Showcase */}
      {products.length === 0 ? (
        <div className="glass flex flex-col items-center justify-center rounded-3xl p-8 sm:p-12 text-center my-6">
          <div className="flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-neutral-200 dark:bg-white/5 text-neutral-400 dark:text-white/40 mb-3 sm:mb-4">
            <PackageOpen size={28} />
          </div>
          ...
          <p className="mt-1 text-xs sm:text-sm text-neutral-500 dark:text-white/50 max-w-md">
